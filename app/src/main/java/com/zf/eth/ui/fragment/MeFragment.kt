...
class MeFragment : BaseFragment() {
    ...
    private val img1=arrayListOf(R.drawable.zhifu,R.drawable.qianbao,R.drawable.c2c_me,R.drawable.xiugaimima,R.drawable.yaoqing,R.drawable.gonggao,R.drawable.keuf,R.drawable.touzi,R.drawable.appicon3_16)
    private val title2=arrayListOf("我的邀请","平台公告","联系客服","退出机制","下载APP")
    private val img2=arrayListOf(R.drawable.yaoqing,R.drawable.gonggao,R.drawable.keuf,R.drawable.touzi,R.drawable.appicon3_16)
